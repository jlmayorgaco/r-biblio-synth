# ============================================================================
# m3_manifest.R - Artifact manifest for M3
# ============================================================================

#' Build M3 artifact manifest
#'
#' @param result A \code{biblio_module_result} object.
#' @param exported A list of exported file paths.
#' @param config A configuration list.
#' @return A \code{biblio_artifact_manifest} object.
#' @export
build_m3_manifest <- function(result, exported = list(), config = biblio_config()) {
